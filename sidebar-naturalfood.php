    ...
    <div class="col-12 ">
				...
				<section class="box">
                 <div class="col-2 col-12-small custom-footer-menu">								
					<header><h3>Agricultural Food Sources</h3></header>
					<?php wp_nav_menu( array( 'theme_location' => 'agrifoodsmenu', 'container_class' => 'custom-menu-class' ) ); ?>
				 </div>
                </section> 
                <section class="box">
				...
				<section class="box">
                 <div class="col-2 col-12-small custom-footer-menu">								
					<header><h3>Tree Food Sources</h3></header>
					<?php wp_nav_menu( array( 'theme_location' => 'treefoodsmenu', 'container_class' => 'custom-menu-class' ) ); ?>
				 </div>
                </section>  
    </div>
</div>
